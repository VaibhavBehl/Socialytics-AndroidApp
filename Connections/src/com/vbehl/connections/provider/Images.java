...
package com.vbehl.connections.provider;
...
public class Images {
	...
	public static String[] imageUrls = new String[] {
			"https://fbcdn-sphotos-a-a.akamaihd.net/hphotos-ak-ash4/305630_10151154860993634_1359468396_n.jpg",
	...
	public static void reloadImages(FbConnectionsApplication application) {
		/*int i = 0, j = 0;
		Set<Show> shows = application.getShows();
		imageThumbUrls = new String[shows.size()];
		Iterator<Show> iterator = shows.iterator();
		while (iterator.hasNext()) {
			Show show = iterator.next();
			if (show.getImageUrl() != null) {
				imageThumbUrls[i++] = show.getImageUrl().toString();
				imageUrls[j++] = show.getImageUrl().toString();
			}
		}*/
